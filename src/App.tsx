  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        {/* Protected — requires sign in + onboarding */}
  ...
  return (
    <div className="min-h-screen relative font-sans flex flex-col transition-colors duration-700 ease-in-out bg-obsidian-950 text-slate-100">
      <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
        <div className="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] bg-gold-600/5 rounded-full blur-[120px]" />
        <div className="absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] bg-obsidian-700/10 rounded-full blur-[120px]" />
      </div>
